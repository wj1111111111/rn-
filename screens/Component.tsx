...
import Vector30 from "../assets/vector";
...
import Component169 from "../assets/";
import Vector135 from "../assets/vector1";
import Polygon108 from "../assets/polygon10";
import Vector217 from "../assets/vector2";
import Component170 from "../assets/";
import Component171 from "../assets/";
import Component172 from "../assets/";
import Component173 from "../assets/";
import Vector38 from "../assets/vector3";
import Group73610 from "../assets/group736";
import Component174 from "../assets/";
import Vector136 from "../assets/vector1";
import Component175 from "../assets/";
import Vector137 from "../assets/vector1";
import Component176 from "../assets/";
import Vector138 from "../assets/vector1";
import Component177 from "../assets/";
import Vector139 from "../assets/vector1";
import Component178 from "../assets/";
  ...
  return (
    <ScrollView style={styles.scrollview}>
      <View style={styles.childPosition}>
        ...
        <View style={styles.groupPosition}>
          <View style={styles.groupPosition}>
            ...
            <Vector30 style={[styles.vectorIcon, styles.iconLayout1]} />
            <Star140
        ...
        />
        <Component169 style={styles.icon} width={16} height={16} />
        <Image
        ...
        <LinearGradient
          ...
          angle={180}
        />
        <Vector135 style={[styles.vectorIcon1, styles.iconLayout1]} />
        ...
        <View style={[styles.groupParent, styles.parentPosition]}>
          ...
          <View style={styles.vectorParent}>
            <Vector217 style={[styles.vectorIcon2, styles.iconLayout1]} />
        ...
        <View style={[styles.parent, styles.iconPosition3]}>
          <Component170 style={[styles.icon20, styles.icon20Position]} />
          <Component171 style={[styles.icon21, styles.iconPosition1]} />
          <Component172 style={[styles.icon22, styles.iconPosition1]} />
          <Component173 style={[styles.icon23, styles.iconPosition1]} />
          ...
          <Vector38 style={[styles.vectorIcon3, styles.iconPosition1]} />
          <Image
      ...
      <View style={styles.group}>
        ...
        <Group73610 style={[styles.instanceChild, styles.iconLayout1]} />
        <Component174 style={[styles.icon24, styles.iconLayout1]} />
      </View>
      <View style={[styles.child, styles.childPosition]} />
      <View
        style={[
          styles.bd57270ff3cddd5d20ff7401e454dcParent,
          styles.bd57270ff3cddd5d20ff7401e454dcLayout,
        ]}
      >
        <Image
        ...
        />
        <Vector136 style={styles.instancePosition} />
        <Image
        ...
        />
        <Text style={[styles.start, styles.startTypo]}>Receive</Text>
        ...
        <Component175 style={styles.iconPosition} />
      </View>
      <View
        style={[
      ...
      >
        ...
        />
        <Vector137 style={[styles.instanceInner, styles.instancePosition]} />
        <Image
          style={[styles.moneyRainIcon, styles.iconPosition3]}
          resizeMode="cover"
        ...
        />
        <Text style={[styles.start1, styles.startTypo]}>Details</Text>
        ...
        <Component176 style={[styles.icon30, styles.iconPosition]} />
      </View>
      <View
        style={[
      ...
      >
        ...
        />
        <Vector138 style={[styles.instanceInner, styles.instancePosition]} />
        <Image
          style={[styles.moneyRainIcon, styles.iconPosition3]}
          resizeMode="cover"
        ...
        <Image
          ...
          source={require("../assets/16.png")}
        />
        <Text style={[styles.start2, styles.startTypo]}>Receive</Text>
        <Text style={[styles.next21001, styles.textFlexBox]}>Next 21:00</Text>
        <View style={styles.rectangleParent13}>
          <View style={[styles.groupChild31, styles.groupChildPosition]} />
          <Text style={[styles.text4, styles.textFlexBox]}>99+</Text>
        ...
        <Component177 style={[styles.icon30, styles.iconPosition]} />
      </View>
      <Image
        style={styles.icon34}
        resizeMode="cover"
      ...
      />
      <View style={[styles.view, styles.bd57270ff3cddd5d20ff7401e454dcLayout]}>
        <Image
          style={styles.bd57270ff3cddd5d20ff7401e454dcIcon}
          resizeMode="cover"
          source={require("../assets/569114bd57270ff3cddd5d20ff7401e454dc67a1f09dic5q4g-fw1200-1.png")}
        ...
        />
        <Vector139 style={[styles.instanceInner, styles.instancePosition]} />
        <Image
          style={[styles.moneyRainIcon, styles.iconPosition3]}
          resizeMode="cover"
        ...
        <Image
          ...
          source={require("../assets/161.png")}
        />
        <Text style={[styles.start3, styles.startTypo]}>23:00 Start</Text>
        <Text style={[styles.next21001, styles.textFlexBox]}>Next 21:00</Text>
        <View style={styles.rectangleParent13}>
          <View style={[styles.groupChild31, styles.groupChildPosition]} />
          <Text style={[styles.text4, styles.textFlexBox]}>99+</Text>
        ...
        <Component178 style={[styles.icon30, styles.iconPosition]} />
      </View>
    </ScrollView>
  );
};
...
const styles = StyleSheet.create({
  ...
  bd57270ff3cddd5d20ff7401e454dcLayout: {
    height: 121,
    width: 121,
    position: "absolute",
  },
