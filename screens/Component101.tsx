...
import Group736149 from "../assets/group7361";
import Component465 from "../assets/";
import Stroke39 from "../assets/stroke";
      ...
      <View style={styles.groupParent}>
        <View style={[styles.rectangleParent, styles.groupChildPosition]}>
          ...
          <View style={styles.r198000Parent}>
            ...
            <Group736149 style={[styles.groupItem, styles.iconLayout]} />
            <Component465 style={[styles.icon, styles.iconLayout]} />
          </View>
        </View>
        <Stroke39 style={[styles.strokeIcon, styles.iconLayout]} />
