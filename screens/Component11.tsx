...
import Star1140 from "../assets/star11";
import Star1141 from "../assets/star11";
import Star1142 from "../assets/star11";
import Star1143 from "../assets/star11";
import Star1144 from "../assets/star11";
import Component214 from "../assets/";
import Vector1119 from "../assets/vector11";
import Polygon1018 from "../assets/polygon101";
import Vector2110 from "../assets/vector21";
import Component215 from "../assets/";
import Component216 from "../assets/";
import Component217 from "../assets/";
import Component218 from "../assets/";
import Vector318 from "../assets/vector31";
import Group73619 from "../assets/group7361";
import Component219 from "../assets/";
import Vector141 from "../assets/vector14";
import Component82 from "../assets/";
import Vector151 from "../assets/vector15";
import Component83 from "../assets/";
import Vector161 from "../assets/vector16";
import Component84 from "../assets/";
import Vector171 from "../assets/vector17";
import Component85 from "../assets/";
  ...
  return (
    <ScrollView style={styles.scrollview}>
      <View style={styles.childPosition}>
        ...
        <View style={styles.groupPosition}>
          <View style={styles.groupPosition}>
            ...
            <Vector48 style={[styles.vectorIcon, styles.iconLayout1]} />
            <Star1140
        ...
        />
        <Component214 style={styles.icon} width={16} height={16} />
        <Image
        ...
        <LinearGradient
          ...
          angle={180}
        />
        <Vector1119 style={[styles.vectorIcon1, styles.iconLayout1]} />
        ...
        <View style={[styles.groupParent, styles.parentPosition]}>
          ...
          <View style={styles.vectorParent}>
            <Vector2110 style={[styles.vectorIcon2, styles.iconLayout1]} />
        ...
        <View style={[styles.parent, styles.iconPosition3]}>
          <Component215 style={[styles.icon20, styles.icon20Position]} />
          <Component216 style={[styles.icon21, styles.iconPosition1]} />
          <Component217 style={[styles.icon22, styles.iconPosition1]} />
          <Component218 style={[styles.icon23, styles.iconPosition1]} />
          ...
          <Vector318 style={[styles.vectorIcon3, styles.iconPosition1]} />
          <Image
        ...
        <View style={styles.group}>
          ...
          <Group73619 style={[styles.instanceChild, styles.iconLayout1]} />
          <Component219 style={[styles.icon24, styles.iconLayout1]} />
        </View>
      </View>
      ...
      <View style={[styles.view, styles.viewLayout]}>
        ...
        />
        <Vector141 style={[styles.item, styles.itemPosition]} />
        <Image
        ...
        <Component82 style={[styles.icon28, styles.iconPosition]} />
      </View>
      <View
      ...
      >
        ...
        />
        <Vector151 style={[styles.item, styles.itemPosition]} />
        <Image
          style={[styles.moneyRainIcon, styles.iconPosition3]}
          resizeMode="cover"
        ...
        <Component83 style={[styles.icon28, styles.iconPosition]} />
      </View>
      <View
        style={[
      ...
      >
        ...
        <Image
          ...
          source={require("../assets/2333-12.png")}
        />
        <Vector161 style={[styles.item, styles.itemPosition]} />
        <Image
          style={[styles.moneyRainIcon, styles.iconPosition3]}
          resizeMode="cover"
          source={require("../assets/1moneyrain2.png")}
        ...
        <Component84 style={[styles.icon28, styles.iconPosition]} />
      </View>
      <View
        style={[
      ...
      >
        ...
        />
        <Vector171 style={styles.itemPosition} />
        <Image
          style={[styles.moneyRainIcon, styles.iconPosition3]}
          resizeMode="cover"
        ...
        <Component85 style={styles.iconPosition} />
      </View>
      <View
        style={[
      ...
      >
        ...
        />
        <Vector181 style={[styles.item, styles.itemPosition]} />
        <Image
          style={[styles.moneyRainIcon, styles.iconPosition3]}
          resizeMode="cover"
        ...
        <Component86 style={[styles.icon28, styles.iconPosition]} />
      </View>
      <View
        style={[
      ...
      >
        ...
        />
        <Vector191 style={[styles.item, styles.itemPosition]} />
        <Image
          style={[styles.moneyRainIcon, styles.iconPosition3]}
          resizeMode="cover"
        ...
        <Component87 style={[styles.icon28, styles.iconPosition]} />
      </View>
    </ScrollView>
  );
};
