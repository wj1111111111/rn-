...
import Vector540 from "../assets/vector5";
...
import Vector2010 from "../assets/vector20";
...
import Vector178 from "../assets/vector1";
import Component413 from "../assets/";
import Vector179 from "../assets/vector1";
import Component414 from "../assets/";
import Vector180 from "../assets/vector1";
  ...
  return (
    <ScrollView style={styles.scrollview}>
      <View style={styles.childPosition}>
        ...
        <View style={styles.groupPosition}>
          <View style={styles.groupPosition}>
            ...
            <Vector1813 style={[styles.vectorIcon, styles.iconLayout1]} />
            <Star1150
        ...
        />
        <Component406 style={styles.icon} width={16} height={16} />
        <Image
        ...
        <LinearGradient
          ...
          angle={180}
        />
        <Vector540 style={[styles.vectorIcon1, styles.iconLayout1]} />
        ...
        <View style={[styles.groupParent, styles.parentPosition]}>
          ...
          <View style={styles.vectorParent}>
            <Vector1913 style={[styles.vectorIcon2, styles.iconLayout1]} />
        ...
        <View style={[styles.parent, styles.iconPosition3]}>
          <Component407 style={[styles.icon20, styles.icon20Position]} />
          <Component408 style={[styles.icon21, styles.iconPosition1]} />
          <Component409 style={[styles.icon22, styles.iconPosition1]} />
          <Component410 style={[styles.icon23, styles.iconPosition1]} />
          ...
          <Vector2010 style={[styles.vectorIcon3, styles.iconPosition1]} />
          <Image
      ...
      <View style={styles.group}>
        ...
        <Group736144 style={[styles.instanceChild, styles.iconLayout1]} />
        <Component411 style={[styles.icon24, styles.iconLayout1]} />
      </View>
      ...
      >
        ...
        />
        <Vector170 style={styles.instancePosition} />
        <Image
        ...
        <Component412 style={styles.iconPosition} />
      </View>
      <View
        style={[
      ...
      >
        ...
        />
        <Vector178 style={[styles.instanceInner, styles.instancePosition]} />
        <Image
          style={[styles.moneyRainIcon, styles.iconPosition3]}
          resizeMode="cover"
        ...
        <Component413 style={[styles.icon30, styles.iconPosition]} />
      </View>
      <View
        style={[
      ...
      >
        ...
        />
        <Vector179 style={[styles.instanceInner, styles.instancePosition]} />
        <Image
          style={[styles.moneyRainIcon, styles.iconPosition3]}
          resizeMode="cover"
        ...
        <Component414 style={[styles.icon30, styles.iconPosition]} />
      </View>
      <Image
        style={styles.icon34}
        resizeMode="cover"
      ...
      <View style={[styles.view, styles.bd57270ff3cddd5d20ff7401e454dcLayout]}>
        ...
        />
        <Vector180 style={[styles.instanceInner, styles.instancePosition]} />
        <Image
          style={[styles.moneyRainIcon, styles.iconPosition3]}
          resizeMode="cover"
        ...
        <Component415 style={[styles.icon30, styles.iconPosition]} />
      </View>
    </ScrollView>
  );
};
