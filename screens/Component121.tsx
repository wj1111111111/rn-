...
import Vector247 from "../assets/vector24";
import Star1230 from "../assets/star12";
import Star1231 from "../assets/star12";
...
import Vector11011 from "../assets/vector110";
import Polygon10110 from "../assets/polygon101";
import Vector257 from "../assets/vector25";
...
import Vector153 from "../assets/vector15";
import Component212 from "../assets/";
import Vector1626 from "../assets/vector16";
import Component213 from "../assets/";
import Vector174 from "../assets/vector17";
  ...
  return (
    <ScrollView style={styles.scrollview}>
      <View style={styles.childPosition}>
        ...
        <View style={styles.groupPosition}>
          <View style={styles.groupPosition}>
            ...
            <Vector247 style={[styles.vectorIcon, styles.iconLayout1]} />
            <Star1230
        ...
        />
        <Component451 style={styles.icon} width={16} height={16} />
        <Image
        ...
        <LinearGradient
          ...
          angle={180}
        />
        <Vector11011 style={[styles.vectorIcon1, styles.iconLayout1]} />
        ...
        <View style={[styles.groupParent, styles.parentPosition]}>
          ...
          <View style={styles.vectorParent}>
            <Vector257 style={[styles.vectorIcon2, styles.iconLayout1]} />
        ...
        <View style={[styles.parent, styles.iconPosition3]}>
          <Component452 style={[styles.icon20, styles.icon20Position]} />
          <Component453 style={[styles.icon21, styles.iconPosition1]} />
          <Component454 style={[styles.icon22, styles.iconPosition1]} />
          <Component455 style={[styles.icon23, styles.iconPosition1]} />
          ...
          <Vector3110 style={[styles.vectorIcon3, styles.iconPosition1]} />
          <Image
        ...
        <View style={styles.group}>
          ...
          <Component456 style={[styles.icon24, styles.iconLayout1]} />
        </View>
      </View>
      ...
      <View style={[styles.view, styles.viewLayout]}>
        ...
        />
        <Vector149 style={[styles.item, styles.itemPosition]} />
        <Image
      ...
      >
        ...
        />
        <Vector153 style={[styles.item, styles.itemPosition]} />
        <Image
          style={[styles.moneyRainIcon, styles.iconPosition3]}
          resizeMode="cover"
      ...
      >
        ...
        <Image
          ...
          source={require("../assets/2333-12.png")}
        />
        <Vector1626 style={[styles.item, styles.itemPosition]} />
        <Image
          style={[styles.moneyRainIcon, styles.iconPosition3]}
          resizeMode="cover"
          source={require("../assets/1moneyrain2.png")}
      ...
      >
        ...
        />
        <Vector174 style={styles.itemPosition} />
        <Image
          style={[styles.moneyRainIcon, styles.iconPosition3]}
          resizeMode="cover"
      ...
      >
        ...
        />
        <Vector186 style={[styles.item, styles.itemPosition]} />
        <Image
          style={[styles.moneyRainIcon, styles.iconPosition3]}
          resizeMode="cover"
      ...
      >
        ...
        />
        <Vector196 style={[styles.item, styles.itemPosition]} />
        <Image
          style={[styles.moneyRainIcon, styles.iconPosition3]}
          resizeMode="cover"
