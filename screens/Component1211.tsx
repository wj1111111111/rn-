...
import Component468 from "../assets/";
import Component469 from "../assets/";
import Group7461 from "../assets/group746";
import Vector544 from "../assets/vector5";
import Group736150 from "../assets/group7361";
import Component470 from "../assets/";
import Vector545 from "../assets/vector5";
...
import Component471 from "../assets/";
import Ellipse441 from "../assets/ellipse44";
import Vector291 from "../assets/vector29";
import Component472 from "../assets/";
import Component473 from "../assets/";
import Component474 from "../assets/";
import Group6291 from "../assets/group629";
import Component475 from "../assets/";
import Stroke310 from "../assets/stroke3";
...
Mouse`}</Text>
        ...
        <View style={[styles.container, styles.containerLayout]}>
          ...
          <View style={[styles.groupParent, styles.groupLayout2]}>
            ...
            <Group736150 style={[styles.instanceItem, styles.iconLayout4]} />
            <Component470 style={[styles.icon12, styles.iconLayout4]} />
          ...
          <View style={[styles.vectorContainer, styles.rectangleIconLayout]}>
            ...
            <Vector262
              ...
              height={16}
            />
            <Vector271 style={[styles.vectorIcon3, styles.vectorIcon3Layout]} />
            <Vector281 style={[styles.vectorIcon4, styles.iconLayout4]} />
            <Group7601
...
Mouse`}</Text>
      ...
      <View style={[styles.parent1, styles.childPosition]}>
        <Component471 style={styles.icon14} />
        <Ellipse441 style={[styles.instanceInner, styles.iconLayout4]} />
        <Vector291 style={[styles.vectorIcon5, styles.iconPosition]} />
        <Component472 style={[styles.icon15, styles.iconLayout]} />
        <Component473 style={[styles.icon16, styles.iconPosition]} />
        <Component474 style={[styles.icon17, styles.iconLayout]} />
