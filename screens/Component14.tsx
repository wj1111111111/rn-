...
import Slot2 from "../assets/slot2";
import Maskgroup26 from "../assets/maskgroup2";
import Group7361130 from "../assets/group73611";
import Component353 from "../assets/";
import Stroke18 from "../assets/stroke";
import Group126619 from "../assets/group12661";
import Group1264720 from "../assets/group12647";
import Group1264721 from "../assets/group12647";
import Group1264810 from "../assets/group12648";
import Group1264910 from "../assets/group12649";
import Group1265010 from "../assets/group12650";
import Group1265110 from "../assets/group12651";
import Maskgroup310 from "../assets/maskgroup3";
import Vector1533 from "../assets/vector15";
import Vector1534 from "../assets/vector15";
import Vector1535 from "../assets/vector15";
import Frame19 from "../assets/frame1";
import Frame110 from "../assets/frame1";
...
const Component14 = () => {
  return (
    <ScrollView style={styles.scrollview}>
        ...
        <View style={styles.instanceParent}>
          <View style={[styles.rectangleParent, styles.iconGroupPosition]}>
            ...
            <View style={styles.r198000Parent}>
              ...
              />
              <Component353 style={[styles.icon, styles.iconGroupLayout]} />
            </View>
          </View>
      ...
      <Group126619 style={styles.groupIcon} width={41} height={20} />
...
5.Your remaining number of re-signments: `}
        ...
        <Group1264720 style={[styles.groupChild1, styles.groupChildLayout2]} />
        <Group1264721 style={[styles.groupChild2, styles.groupChildLayout2]} />
        <Group1264810 style={[styles.groupChild3, styles.groupChildLayout1]} />
        <Text style={[styles.signInRules, styles.finishedFlexBox]}>
          Sign-in rules
        </Text>
        <Group1264910 style={[styles.groupChild4, styles.groupChildLayout1]} />
        <Group1265010 style={[styles.groupChild5, styles.groupChildLayout]} />
        <Group1265110 style={[styles.groupChild6, styles.groupChildLayout]} />
      </View>
      <Image
        style={[
      ...
      <View style={[styles.groupContainer, styles.groupPosition]}>
        <View style={[styles.groupView, styles.groupPosition]}>
          <View style={[styles.groupView, styles.groupPosition]}>
            ...
            <View style={[styles.groupChild8, styles.text4Position]} />
            <Text
...
Deposit amount： ₱200 `}</Text>
      ...
      <View style={styles.groupParent2}>
        <View style={[styles.rectangleParent, styles.iconGroupPosition]}>
          <View style={[styles.groupChild12, styles.iconGroupPosition]} />
      ...
      <Image
        ...
        source={require("../assets/1-733643593.png")}
      />
      <Vector1533 style={[styles.vectorIcon, styles.vectorIconLayout]} />
      <Vector1534 style={[styles.vectorIcon1, styles.vectorIconLayout]} />
      <Vector1535 style={[styles.vectorIcon2, styles.vectorIconLayout]} />
      ...
      <View
        style={[styles.activityTime29day235959Parent, styles.activityLayout]}
      >
        <Text
          style={[
        ...
        <Frame19
          style={[styles.frameIcon, styles.activityLayout]}
          width={22}
          height={22}
        />
      </View>
      <View
        style={[styles.activityTime29day235959Group, styles.activityLayout]}
      >
        <Text
          style={[
            styles.activityTime29dayContainer,
