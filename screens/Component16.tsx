...
import Vector175 from "../assets/vector17";
import Maskgroup312 from "../assets/maskgroup3";
import Vector1640 from "../assets/vector16";
import Vector1641 from "../assets/vector16";
import Vector1642 from "../assets/vector16";
        ...
        <View style={[styles.instanceParent, styles.collectChildPosition]}>
          <View style={[styles.rectangleParent, styles.iconGroupPosition]}>
            ...
            <View style={styles.r198000Parent}>
              ...
              <Group736140 style={[styles.groupItem, styles.iconGroupLayout]} />
              <Component396 style={[styles.icon, styles.iconGroupLayout]} />
            </View>
          </View>
          <Stroke34 style={[styles.strokeIcon, styles.iconGroupLayout]} />
...
it will return to Day 1 and start again.`}</Text>
        <Vector175 style={[styles.vectorIcon, styles.lineViewLayout]} />
      </View>
      <LinearGradient
      ...
      <Image
        ...
        source={require("../assets/1-733643593.png")}
      />
      <Vector1640 style={[styles.vectorIcon1, styles.vectorIconLayout]} />
      <Vector1641 style={[styles.vectorIcon2, styles.vectorIconLayout]} />
      <Vector1642 style={[styles.vectorIcon3, styles.vectorIconLayout]} />
