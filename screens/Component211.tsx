...
import Component271 from "../assets/";
import Component272 from "../assets/";
import Component273 from "../assets/";
import Component274 from "../assets/";
import Component275 from "../assets/";
import Component276 from "../assets/";
import Vector176 from "../assets/vector17";
import Component277 from "../assets/";
import Frame21 from "../assets/frame2";
import Vector186 from "../assets/vector18";
import Vector187 from "../assets/vector18";
...
const Component21 = () => {
  return (
    <SafeAreaView style={styles.safeareaview}>
      ...
      <Stroke32 style={[styles.strokeIcon, styles.iconLayout2]} />
      ...
      <View style={[styles.group, styles.groupPosition1]}>
        <Component272 style={[styles.icon1, styles.iconPosition]} />
        <Text style={[styles.password, styles.passwordTypo]}>Password</Text>
        <Component273 style={[styles.icon2, styles.iconLayout2]} />
        <Component274 style={[styles.icon3, styles.iconLayout2]} />
      </View>
      <Component275 style={[styles.icon4, styles.groupPosition1]} />
      <Text style={[styles.username, styles.usernameTypo]}>1234567890|</Text>
      <Component276 style={[styles.icon5, styles.iconLayout2]} />
      <Text style={[styles.username1, styles.usernameTypo]}>+55</Text>
      <View style={styles.item} />
      <Vector176 style={[styles.vectorIcon, styles.iconLayout2]} />
      <Image
      ...
      <View style={[styles.container, styles.groupPosition1]}>
        <Component277 style={[styles.icon1, styles.iconPosition]} />
      ...
      <View style={[styles.groupParent, styles.groupParentLayout]}>
        ...
        >
          ...
          <Vector186 style={[styles.vectorIcon1, styles.iconPosition]} />
        </View>
      </View>
      <View style={[styles.groupContainer, styles.groupParentLayout]}>
        ...
        >
          ...
          <Vector187 style={[styles.vectorIcon1, styles.iconPosition]} />
        </View>
      </View>
