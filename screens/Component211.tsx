...
import Vector248 from "../assets/vector24";
...
import Vector11012 from "../assets/vector110";
import Polygon10111 from "../assets/polygon101";
import Vector258 from "../assets/vector25";
...
import Vector1104 from "../assets/vector110";
  ...
  return (
    <ScrollView style={styles.scrollview}>
      <View style={styles.childPosition}>
        ...
        <View style={styles.groupPosition}>
          <View style={styles.groupPosition}>
            ...
            <Vector248 style={[styles.vectorIcon, styles.iconPosition4]} />
            <Star1235
        ...
        />
        <Component457 style={styles.icon} width={16} height={16} />
        <Image
        ...
        <LinearGradient
          ...
          angle={180}
        />
        <Vector11012 style={styles.vectorIcon1} />
        ...
        <View style={[styles.groupParent, styles.parentPosition]}>
          ...
          <View style={styles.vectorParent}>
            <Vector258 style={[styles.vectorIcon2, styles.iconPosition4]} />
        ...
        <View style={[styles.parent, styles.iconPosition3]}>
          <Component458 style={[styles.icon20, styles.icon20Position]} />
          <Component459 style={[styles.icon21, styles.iconPosition1]} />
          <Component460 style={[styles.icon22, styles.iconPosition1]} />
          <Component461 style={[styles.icon23, styles.iconPosition1]} />
          ...
          <Vector3111 style={[styles.vectorIcon3, styles.iconPosition1]} />
          <Image
      ...
      <View style={[styles.group, styles.viewPosition]}>
        ...
        <Component462 style={[styles.icon24, styles.iconPosition4]} />
      </View>
      ...
      <View style={styles.bd57270ff3cddd5d20ff7401e454dcParent}>
        ...
        />
        <Vector1104 style={styles.instanceItem} />
        <Image
