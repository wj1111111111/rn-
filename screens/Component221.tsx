...
import Component511 from "../assets/";
import Component512 from "../assets/";
import Component513 from "../assets/";
import Component514 from "../assets/";
import Component515 from "../assets/";
import Component516 from "../assets/";
import Vector1319 from "../assets/vector13";
import Vector386 from "../assets/vector38";
import Vector387 from "../assets/vector38";
  ...
  return (
    <SafeAreaView style={styles.safeareaview}>
      ...
      <View style={[styles.group, styles.groupPosition1]}>
        <Component512 style={[styles.icon1, styles.iconPosition]} />
        <Text style={[styles.password, styles.passwordTypo]}>Password</Text>
        <Component513 style={[styles.icon2, styles.iconLayout1]} />
        <Component514 style={[styles.icon3, styles.iconLayout1]} />
      </View>
      <Component515 style={[styles.icon4, styles.groupPosition1]} />
      <Text style={[styles.username, styles.usernameTypo]}>1234567890|</Text>
      <Component516 style={[styles.icon5, styles.iconLayout1]} />
      <Text style={[styles.username1, styles.usernameTypo]}>+55</Text>
      <View style={styles.item} />
      <Vector1319 style={[styles.vectorIcon, styles.iconLayout1]} />
      <Image
      ...
      <View style={[styles.groupParent, styles.groupParentLayout]}>
        ...
        >
          ...
          <Vector386 style={[styles.vectorIcon1, styles.iconPosition]} />
        </View>
      </View>
      <View style={[styles.groupContainer, styles.groupParentLayout]}>
        ...
        >
          ...
          <Vector387 style={[styles.vectorIcon1, styles.iconPosition]} />
        </View>
      </View>
