...
import Vector1712 from "../assets/vector17";
...
import Vector4143 from "../assets/vector41";
...
import Group7361137 from "../assets/group73611";
  ...
  return (
    <ScrollView style={styles.scrollview}>
      <View style={styles.childPosition}>
        ...
        <View style={styles.groupPosition}>
          <View style={styles.groupPosition}>
            ...
            <Vector1712 style={[styles.vectorIcon, styles.iconLayout1]} />
            <Star1150
        ...
        <LinearGradient
          ...
          angle={180}
        />
        <Vector4143 style={[styles.vectorIcon1, styles.iconLayout1]} />
        ...
        <View style={[styles.groupParent, styles.parentPosition]}>
          ...
          <View style={styles.vectorParent}>
            <Vector1812 style={[styles.vectorIcon2, styles.iconLayout1]} />
        ...
        <View style={[styles.parent, styles.iconPosition3]}>
          ...
          <Vector1912 style={[styles.vectorIcon3, styles.iconPosition1]} />
          <Image
      ...
      <View style={styles.group}>
        ...
        <Group7361137 style={[styles.instanceChild, styles.iconLayout1]} />
      ...
      >
        ...
        />
        <Vector1100 style={styles.instancePosition} />
        <Image
      ...
      >
        ...
        />
        <Vector1102 style={[styles.instanceInner, styles.instancePosition]} />
        <Image
          style={[styles.moneyRainIcon, styles.iconPosition3]}
          resizeMode="cover"
