...
import Vector15116 from "../assets/vector151";
    ...
    <ScrollView style={styles.scrollview}>
      <View style={styles.childPosition}>
        ...
        <View style={styles.groupPosition}>
          <View style={styles.groupPosition}>
            ...
            <Vector15116 style={[styles.vectorIcon, styles.iconLayout1]} />
            <Star1230
        ...
        <LinearGradient
          ...
          angle={180}
        />
        <Vector1618 style={[styles.vectorIcon1, styles.iconLayout1]} />
        ...
        <View style={[styles.groupParent, styles.parentPosition]}>
          ...
          <View style={styles.vectorParent}>
            <Vector2117 style={[styles.vectorIcon2, styles.iconLayout1]} />
      ...
      <View style={[styles.view, styles.viewLayout]}>
        ...
        <Image
          ...
          resizeMode="cover"
          source={require("../assets/1moneyrain11.png")}
        />
        <Image
          style={styles.icon27}
          resizeMode="cover"
      ...
      >
        ...
        <Image
          style={styles.icon26}
          resizeMode="cover"
          source={require("../assets/2333-121.png")}
        />
        <Vector1526 style={[styles.item, styles.itemPosition]} />
        <Image
          style={[styles.moneyRainIcon, styles.iconPosition3]}
          resizeMode="cover"
          source={require("../assets/1moneyrain21.png")}
        />
        <Image
          style={styles.icon27}
          resizeMode="cover"
      ...
      >
        ...
        <Image
          ...
          source={require("../assets/2333-121.png")}
        />
        <Vector164 style={[styles.item, styles.itemPosition]} />
        <Image
          style={[styles.moneyRainIcon, styles.iconPosition3]}
          resizeMode="cover"
          source={require("../assets/1moneyrain21.png")}
      ...
      >
        ...
        />
        <Vector176 style={styles.itemPosition} />
        <Image
          style={[styles.moneyRainIcon, styles.iconPosition3]}
          resizeMode="cover"
