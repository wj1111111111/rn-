...
import Vector47 from "../assets/vector";
...
import Component205 from "../assets/";
import Vector160 from "../assets/vector1";
import Polygon1017 from "../assets/polygon10";
import Vector220 from "../assets/vector2";
import Component206 from "../assets/";
import Component207 from "../assets/";
import Component208 from "../assets/";
import Component209 from "../assets/";
import Vector317 from "../assets/vector3";
import Group73618 from "../assets/group736";
import Component210 from "../assets/";
import Vector163 from "../assets/vector1";
import Component211 from "../assets/";
import Vector164 from "../assets/vector1";
  ...
  return (
    <ScrollView style={styles.scrollview}>
      <View style={styles.childPosition}>
        ...
        <View style={styles.groupPosition}>
          <View style={styles.groupPosition}>
            ...
            <Vector47 style={[styles.vectorIcon, styles.iconLayout1]} />
            <Star155
        ...
        />
        <Component205 style={styles.icon} width={16} height={16} />
        <Image
        ...
        <LinearGradient
          ...
          angle={180}
        />
        <Vector160 style={[styles.vectorIcon1, styles.iconLayout1]} />
        ...
        <View style={[styles.groupParent, styles.parentPosition]}>
          ...
          <View style={styles.vectorParent}>
            <Vector220 style={[styles.vectorIcon2, styles.iconLayout1]} />
        ...
        <View style={[styles.parent, styles.iconPosition3]}>
          <Component206 style={[styles.icon20, styles.icon20Position]} />
          <Component207 style={[styles.icon21, styles.iconPosition1]} />
          <Component208 style={[styles.icon22, styles.iconPosition1]} />
          <Component209 style={[styles.icon23, styles.iconPosition1]} />
          ...
          <Vector317 style={[styles.vectorIcon3, styles.iconPosition1]} />
          <Image
      ...
      <View style={styles.group}>
        ...
        <Group73618 style={[styles.instanceChild, styles.iconLayout1]} />
        <Component210 style={[styles.icon24, styles.iconLayout1]} />
      </View>
      ...
      >
        ...
        />
        <Vector163 style={styles.instancePosition} />
        <Image
        ...
        <Component211 style={styles.iconPosition} />
      </View>
      <View
        style={[
      ...
      >
        ...
        />
        <Vector164 style={[styles.instanceInner, styles.instancePosition]} />
        <Image
          style={[styles.moneyRainIcon, styles.iconPosition3]}
          resizeMode="cover"
        ...
        <Component212 style={[styles.icon30, styles.iconPosition]} />
      </View>
      <Image
        style={styles.icon31}
        resizeMode="cover"
