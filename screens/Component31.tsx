...
import Component226 from "../assets/";
import Vector1122 from "../assets/vector11";
  ...
  return (
    <ScrollView style={styles.scrollview}>
      <View style={[styles.rectangleParent, styles.groupPosition]}>
        ...
        />
        <Component226 style={styles.icon} width={16} height={16} />
        <Image
        ...
        <LinearGradient
          ...
          angle={180}
        />
        <Vector1122 style={[styles.vectorIcon, styles.iconLayout1]} />
        ...
        />
        <GroupComponent prop={<Component68 width={100} height={81} />} />
      </View>
      <View style={[styles.rectangleParent, styles.groupPosition]} />
      <Component5
        groupViewTop={426}
