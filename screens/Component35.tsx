...
import Vector1715 from "../assets/vector17";
import Star1165 from "../assets/star11";
import Star1166 from "../assets/star11";
      ...
      <View style={styles.rectangleParent}>
        ...
        <View style={styles.groupPosition}>
          <View style={styles.groupPosition}>
            ...
            <Vector1715 style={[styles.vectorIcon, styles.childIconLayout]} />
            <Star1165
        ...
        <View style={styles.groupParent}>
          ...
          <View style={styles.vectorParent}>
            <Vector1815 style={[styles.vectorIcon2, styles.childIconLayout]} />
        ...
        <View style={[styles.parent, styles.icon1Position]}>
          ...
          <Vector1915 style={[styles.vectorIcon3, styles.iconPosition2]} />
          <Image
