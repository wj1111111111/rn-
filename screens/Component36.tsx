...
import Vector1716 from "../assets/vector17";
      ...
      <View style={styles.groupParent}>
        <View style={styles.groupParent}>
          ...
          <View style={[styles.groupView, styles.iconGroupLayout]}>
            ...
            <Image
              style={[styles.logoWj931Icon, styles.vectorIconLayout]}
              resizeMode="cover"
          ...
          />
          <View
            style={[styles.rectangleWrapper2, styles.logoWj931Icon1Position]}
          >
            <LinearGradient
        ...
        <View style={[styles.jdbSlot105Parent, styles.groupChild5Layout]}>
          ...
          />
          <Image
            style={[styles.icon20, styles.iconParentPosition]}
            resizeMode="cover"
            source={require("../assets/45--1000.png")}
          />
          <Image
            style={[styles.icon21, styles.iconGroupLayout]}
            resizeMode="cover"
          ...
          />
          <Image
            style={[styles.icon23, styles.iconParentPosition]}
            resizeMode="cover"
            source={require("../assets/85--1000.png")}
          />
          <Image
            style={[styles.icon24, styles.groupChildLayout1]}
            resizeMode="cover"
          ...
          <View style={[styles.logo1Parent, styles.parentGroupPosition]}>
            <Image
            ...
            >
              ...
              <View style={styles.groupParent2}>
                <View
                  style={[styles.groupWrapper5, styles.parentGroupPosition]}
                >
                  <View
                    style={[styles.vectorGroup, styles.parentGroupPosition]}
                  >
                    <Ellipse267
            ...
            <Image
              style={[styles.logoWj931Icon2, styles.vectorIconLayout]}
              resizeMode="cover"
              source={require("../assets/logowj93-11.png")}
            />
            <Image
