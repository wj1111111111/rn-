...
import Group73620 from "../assets/group736";
import Component227 from "../assets/";
import Stroke4 from "../assets/stroke";
      ...
      <View style={styles.groupParent}>
        <View style={[styles.rectangleParent, styles.groupChildPosition]}>
          ...
          <View style={styles.r198000Parent}>
            ...
            <Group73620 style={[styles.groupItem, styles.iconLayout]} />
            <Component227 style={[styles.icon, styles.iconLayout]} />
          </View>
        </View>
        <Stroke4 style={[styles.strokeIcon, styles.iconLayout]} />
