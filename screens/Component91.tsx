...
import Group736148 from "../assets/group7361";
import Component464 from "../assets/";
import Stroke38 from "../assets/stroke";
      ...
      <View style={styles.groupParent}>
        <View style={[styles.rectangleParent, styles.groupChildPosition]}>
          ...
          <View style={styles.r198000Parent}>
            ...
            <Group736148 style={[styles.groupItem, styles.iconLayout]} />
            <Component464 style={[styles.icon, styles.iconLayout]} />
          </View>
        </View>
        <Stroke38 style={[styles.strokeIcon, styles.iconLayout]} />
